...
export default function CreateClient() {
  ...
  async function submit(e) {
    ...
    if (needsDocument && !docData)
      nextErrors.document =
        "A supporting document is required for Complimentary meal benefit.";
    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-ink-400">
          Profile and login account are created immediately — no approval step.
        </p>
      </div>
      ...
      >
        ...
        <FormField
          label="Meal Benefit"
          hint="Complimentary requires a supporting document"
        >
          <select
